            ...
            <div id="post-id-${this.id}">
                ...
                <div class="edit-form" id="edit-${this.id}" >
                    <form id="edit-form-${this.id}">
                        <input type="hidden" class="form-control" id="${postAuthor.id}" ></input>
                        <input type="text" class="form-control" id="title-input-${this.id}" placeholder="${this.content}"></input> 
                        <input type="text" class="form-control" id="feeling-input-${this.id}" placeholder="Enter feeling"></input>       
                        <input type="text" class="form-control" id="media-input-${this.id}" placeholder="Enter Gif link"></input>  
